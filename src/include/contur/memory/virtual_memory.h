...
namespace contur {
    ...
    public:
        ...
        [[nodiscard]] Result<MemoryAddress> allocateSlot(ProcessId processId,
                                                          std::size_t size) override;
        [[nodiscard]] Result<void> freeSlot(ProcessId processId) override;
        [[nodiscard]] Result<void> loadSegment(ProcessId processId,
                                                const std::vector<Block>& data) override;
