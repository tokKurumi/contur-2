...
namespace contur {
    ...
    public:
        ...
        [[nodiscard]] virtual Result<Block> read(ProcessId processId,
                                                 MemoryAddress virtualAddress) const = 0;
        ...
        [[nodiscard]] virtual Result<void> write(ProcessId processId, MemoryAddress virtualAddress,
                                                 const Block& block) = 0;
        ...
        [[nodiscard]] virtual Result<MemoryAddress> allocate(ProcessId processId,
        ...
        [[nodiscard]] virtual Result<void> swapIn(ProcessId processId,
                                                  MemoryAddress virtualAddress) = 0;

        /// @brief Swaps a page out of physical memory (to simulated disk).
        /// @param processId The owning process.
        /// @param virtualAddress A virtual address within the target page.
        /// @return Success, or an error if swap fails.
        [[nodiscard]] virtual Result<void> swapOut(ProcessId processId,
                                                   MemoryAddress virtualAddress) = 0;
